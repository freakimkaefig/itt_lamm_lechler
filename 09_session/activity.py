...
if __name__ == '__main__':
    ...
    # Y
    # buffer for Y
    yBufferNode = fc.createNode('CSV', pos=(150, -300))
    # fft for Y
    yFftNode = fc.createNode('Fft', pos=(600, -300))
    ...
    fc.connectTerminals(yBufferNode['dataOut'], yFftNode['dataIn'])
    fc.connectTerminals(yFftNode['dataOut'], yFftPlotNode['In'])

    # Z
    # buffer for Z
    zBufferNode = fc.createNode('CSV', pos=(150, -150))
    # fft for Z
    zFftNode = fc.createNode('Fft', pos=(600, -150))
    ...
    fc.connectTerminals(zBufferNode['dataOut'], zFftNode['dataIn'])
    fc.connectTerminals(zFftNode['dataOut'], zFftPlotNode['In'])
    """
    win.show()
