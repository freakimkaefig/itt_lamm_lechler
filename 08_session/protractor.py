...
class WiimoteNode(Node):
    ...
    def set_ir_plotNode(self, plotNode):
    ...
    def connect_wiimote(self):
        ...
        if len(self.btaddr) == 17:
            ...
            if self.wiimote is None:
                ...
                self.plotNode.setwiimote(self.wiimote)
...
class IrPlotNode(Node):
    ...
    def calculate_max_light(self, ir):
        ...
        for val in ir:
            if int(maxLight['id']) == int(val['id']):
                ...
                if self.wiimote.buttons['A'] == True:
                    self.aPressed = True
                    #self.plotNode.true = True
                    self.savePath()
                if self.wiimote.buttons['A'] == False:
                    if self.aPressed:
    ...
    def plotVal2(self, vals):
        ...
        for point in vals:
            ...
            counter += 1
        self.spi2.addPoints(points)
        self.plot.addItem(self.spi2)
    ...
    def plotVal(self, val):
        #print val
        self.spi.clear()
        points = [{'pos': [1024 - val[0], 768 - re[1]], 'data': 1}]
...
if __name__ == '__main__':
    ...
    wiimoteNode.set_ir_plotNode(irPlotNode)
